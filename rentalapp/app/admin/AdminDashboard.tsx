  ...
  return (
    <main className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="mx-auto max-w-7xl">
        ...
        <p className="mt-1 text-sm text-gray-600">Manage everything in one place.</p>
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-3">
         <div className="rounded-xl border bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-lg font-semibold text-gray-800">Latest Properties</h2>
          <LatestProperties />
        </div>
          <div className="rounded-xl border bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-lg font-semibold text-gray-800">Latest Agents</h2>
          <LatestAgents />
        </div>
         <div className="rounded-xl border bg-white p-6 shadow-sm">
          <h2 className="mb-4 text-lg font-semibold text-gray-800">Reserved Properties</h2>
          <ReservedProperties />
        </div>
        </div>
      </div>
